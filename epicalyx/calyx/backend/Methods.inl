...
void Emit(LoadGlobal<i8>& op) final;
void Emit(LoadGlobal<u8>& op) final;
void Emit(LoadGlobal<i16>& op) final;
void Emit(LoadGlobal<u16>& op) final;
void Emit(LoadGlobal<i32>& op) final;
void Emit(LoadGlobal<u32>& op) final;
void Emit(LoadGlobal<i64>& op) final;
void Emit(LoadGlobal<u64>& op) final;
void Emit(LoadGlobal<float>& op) final;
void Emit(LoadGlobal<double>& op) final;
void Emit(LoadGlobal<Struct>& op) final;
void Emit(LoadGlobal<Pointer>& op) final;
void Emit(StoreGlobal<i8>& op) final;
void Emit(StoreGlobal<u8>& op) final;
void Emit(StoreGlobal<i16>& op) final;
void Emit(StoreGlobal<u16>& op) final;
void Emit(StoreGlobal<i32>& op) final;
void Emit(StoreGlobal<u32>& op) final;
void Emit(StoreGlobal<i64>& op) final;
void Emit(StoreGlobal<u64>& op) final;
void Emit(StoreGlobal<float>& op) final;
void Emit(StoreGlobal<double>& op) final;
void Emit(StoreGlobal<Struct>& op) final;
void Emit(StoreGlobal<Pointer>& op) final;
...
void Emit(Call<i32>& op) final;
void Emit(Call<u32>& op) final;
void Emit(Call<i64>& op) final;
void Emit(Call<u64>& op) final;
void Emit(Call<float>& op) final;
void Emit(Call<double>& op) final;
void Emit(Call<Struct>& op) final;
void Emit(Call<Pointer>& op) final;
void Emit(Call<void>& op) final;
void Emit(CallLabel<i32>& op) final;
void Emit(CallLabel<u32>& op) final;
void Emit(CallLabel<i64>& op) final;
void Emit(CallLabel<u64>& op) final;
void Emit(CallLabel<float>& op) final;
void Emit(CallLabel<double>& op) final;
void Emit(CallLabel<Struct>& op) final;
void Emit(CallLabel<Pointer>& op) final;
void Emit(CallLabel<void>& op) final;
