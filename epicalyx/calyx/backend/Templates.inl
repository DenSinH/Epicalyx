...
void BACKEND_NAME::Emit(const BinopImm<i32>& op) { EmitBinopImm(op); }
void BACKEND_NAME::Emit(const BinopImm<u32>& op) { EmitBinopImm(op); }
void BACKEND_NAME::Emit(const BinopImm<i64>& op) { EmitBinopImm(op); }
void BACKEND_NAME::Emit(const BinopImm<u64>& op) { EmitBinopImm(op); }
void BACKEND_NAME::Emit(const BinopImm<float>& op) { EmitBinopImm(op); }
void BACKEND_NAME::Emit(const BinopImm<double>& op) { EmitBinopImm(op); }
...
void BACKEND_NAME::Emit(const ShiftImm<i32>& op) { EmitShiftImm(op); }
void BACKEND_NAME::Emit(const ShiftImm<u32>& op) { EmitShiftImm(op); }
void BACKEND_NAME::Emit(const ShiftImm<i64>& op) { EmitShiftImm(op); }
void BACKEND_NAME::Emit(const ShiftImm<u64>& op) { EmitShiftImm(op); }
...
void BACKEND_NAME::Emit(const CompareImm<i32>& op) { EmitCompareImm(op); }
void BACKEND_NAME::Emit(const CompareImm<u32>& op) { EmitCompareImm(op); }
void BACKEND_NAME::Emit(const CompareImm<i64>& op) { EmitCompareImm(op); }
void BACKEND_NAME::Emit(const CompareImm<u64>& op) { EmitCompareImm(op); }
void BACKEND_NAME::Emit(const CompareImm<float>& op) { EmitCompareImm(op); }
void BACKEND_NAME::Emit(const CompareImm<double>& op) { EmitCompareImm(op); }
void BACKEND_NAME::Emit(const CompareImm<Pointer>& op) { EmitCompareImm(op); }
...
void BACKEND_NAME::Emit(const BranchCompareImm<i32>& op) { EmitBranchCompareImm(op); }
void BACKEND_NAME::Emit(const BranchCompareImm<u32>& op) { EmitBranchCompareImm(op); }
void BACKEND_NAME::Emit(const BranchCompareImm<i64>& op) { EmitBranchCompareImm(op); }
void BACKEND_NAME::Emit(const BranchCompareImm<u64>& op) { EmitBranchCompareImm(op); }
void BACKEND_NAME::Emit(const BranchCompareImm<float>& op) { EmitBranchCompareImm(op); }
void BACKEND_NAME::Emit(const BranchCompareImm<double>& op) { EmitBranchCompareImm(op); }
void BACKEND_NAME::Emit(const BranchCompareImm<Pointer>& op) { EmitBranchCompareImm(op); }
